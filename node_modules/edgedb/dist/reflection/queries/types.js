        ...
        switch (type.kind) {
            ...
            case "multirange":
                type.multirange_element_id =
                    (_e = (_d = exports.typeMapping.get(type.multirange_element_id)) === null || _d === void 0 ? void 0 : _d.id) !== null && _e !== void 0 ? _e : type.multirange_element_id;
                break;
            case "range":
                type.range_element_id =
                    (_g = (_f = exports.typeMapping.get(type.range_element_id)) === null || _f === void 0 ? void 0 : _f.id) !== null && _g !== void 0 ? _g : type.range_element_id;
                break;
            case "object":
                const ptrs = {};
