...
async function getMatches(root) {
    return edgedb_1.adapter.walk(root, {
        ...
        skip: [
            /node_modules/,
            RegExp(`dbschema\\${edgedb_1.adapter.path.sep}migrations`),
            RegExp(`dbschema\\${edgedb_1.adapter.path.sep}fixups`),
        ],
    });
}
...
export async function ${functionName}(client: Executor${hasArgs ? `, args: ${argsInterfaceName}` : ""}): Promise<${returnsInterfaceName}> {
