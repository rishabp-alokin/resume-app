...
const getStringRepresentation = (type, params) => {
    ...
    if (type.kind === "object") {
        ...
        if ((_c = type.union_of) === null || _c === void 0 ? void 0 : _c.length) {
        ...
        return {
            staticType: [(0, genutil_1.getRef)(type.name), ((_d = casts === null || casts === void 0 ? void 0 : casts[type.id]) === null || _d === void 0 ? void 0 : _d.length) ? suffix : ""],
            runtimeType: [(0, genutil_1.getRef)(type.name)],
        };
    }
...
const generateObjectTypes = (params) => {
    ...
    for (const type of types.values()) {
        ...
        const isUnionType = Boolean((_a = type.union_of) === null || _a === void 0 ? void 0 : _a.length);
        const isIntersectionType = Boolean((_b = type.intersection_of) === null || _b === void 0 ? void 0 : _b.length);
