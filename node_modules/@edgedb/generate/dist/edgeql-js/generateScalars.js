...
const generateScalars = (params) => {
    ...
    for (const type of types.values()) {
        ...
        const tsType = (0, genutil_1.toTSScalarType)(baseType !== null && baseType !== void 0 ? baseType : type, types);
        if (type.cast_type) {
            ...
            const argTypes = ((_c = (_b = genutil_1.scalarToLiteralMapping[mapped.name]) === null || _b === void 0 ? void 0 : _b.argTypes) !== null && _c !== void 0 ? _c : []).join(" | ");
            sc.writeln([
                (0, builders_1.t) `export `,
                (0, builders_1.dts) `declare `,
            ...
            const extraTypes = (((_d = genutil_1.scalarToLiteralMapping[type.name]) === null || _d === void 0 ? void 0 : _d.extraTypes) || ["never"]).join(" | ");
            const argTypes = ((_f = (_e = genutil_1.scalarToLiteralMapping[type.name]) === null || _e === void 0 ? void 0 : _e.argTypes) !== null && _f !== void 0 ? _f : []).join(" | ");
            sc.writeln([
                (0, builders_1.t) `export `,
                (0, builders_1.dts) `declare `,
        ...
        if ((_g = casts.implicitCastFromMap[type.id]) === null || _g === void 0 ? void 0 : _g.length) {
            sc.writeln([
                (0, builders_1.t) `export `,
                (0, builders_1.dts) `declare `,
        ...
        if ((_h = casts.assignableByMap[type.id]) === null || _h === void 0 ? void 0 : _h.length) {
            sc.writeln([
                (0, builders_1.t) `export `,
                (0, builders_1.dts) `declare `,
